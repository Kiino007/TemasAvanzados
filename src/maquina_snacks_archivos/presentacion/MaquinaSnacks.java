...
public class MaquinaSnacks {
    ...
    private static boolean ejecutarOpciones(int opcion, Scanner consola, List<Snack> productos, IServicioSnacks servicioSnacks){
        ...
        switch (opcion){
            ...
            case 3 -> agregarSanck(consola, servicioSnacks);
            case 4 -> slistarInventarioSnacks(consola, servicioSnacks);
            case 5 -> {
    ...
    private static void slistarInventarioSnacks(Scanner consola, IServicioSnacks servicioSnacks){
        servicioSnacks.mostrarSnack();
    }
    ...
    private static void agregarSanck(Scanner consola, IServicioSnacks servicioSnacks){
